...
function page() {
    ...
    if (mounted) {
        return (
            <>
                <div className='flex '>
                    <div className='w-1/2 px-10 py-10 h-screen overflow-y-hidden'>
                        <div>
                            <Link href="/" >
                                <svg className='block w-34 p-2' viewBox="0 0 80 17" fill="none" xmlns="http://www.w3.org/2000/svg" >
                        ...
                        <div className='flex flex-col items-center mx-auto max-w-120'>
                            <h1 className='text-5xl font-extrabold mt-10 mb-4'>Join Linktree</h1>
                            <p className='text-gray-500 my-2'>Sign up for free!</p>
                            <div className=' flex flex-col w-full mt-10 gap-2'>
                                <input value={email} onChange={(e) => { setEmail(e.target.value), (email.includes('@gmail.com') ? setDisabled(true) : setDisabled(false)) }} className='bg-gray-100 px-4 py-3 w-full rounded-xl placeholder:text-[14px]' type='email' placeholder='Email' />
                                <button className={`px-4 py-3 w-full font-bold rounded-full cursor-pointer ${disabled ? 'bg-purple-600 text-white' : 'bg-[#a8aaa2]/40 text-neutral-400'}`}>Continue</button>
                            </div>
                            <span className='text-[#676b5f] mt-6 text-[15px] text-center'>
                                By clicking <span className='font-semibold'>Create account,</span> you agree to Linktree's <Link href="/" className='underline'>privacy notice</Link>, <Link href="/" className='underline'>T&Cs</Link> and to receive offers, news and updates.
                            </span>
                            <p className='my-4 text-gray-400'>OR</p>
                            <div className='w-full flex flex-col gap-2'>
                                <button className='bg-white flex gap-3 justify-center items-center border border-gray-400/40 hover:border-gray-400/0 px-4 py-3 w-full font-bold text-neutral-950 rounded-xl hover:bg-gray-400/10 cursor-pointer'>
                                    <svg className='w-6 h-fit' xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                                ...
                                <button className='bg-white flex gap-3 justify-center items-center border border-gray-400/40 hover:border-gray-400/0 px-4 py-3 w-full font-bold text-neutral-950 rounded-xl hover:bg-gray-400/10 cursor-pointer'>
                                    <svg className='w-6 h-fit' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50">
                            ...
                            <div className='my-5 flex flex-col items-center gap-5'>
                                <span className='text-gray-400'>Already have an account? <Link href="/login" className='text-[#8129d9] text-[14px] underline '>Login</Link></span>
                            </div>
                        </div>
                    </div>
                    <div className='w-1/2 h-screen overflow-hidden'>
                        <img className='w-full object-cover select-none mt-[-50%]' src="https://assets.production.linktr.ee/auth/3448/media/banner-register-social-desktop.18fa56fce6ad2db4f48b.webp" alt="Login banner" />
                    </div>
                </div>
            </>
        )
